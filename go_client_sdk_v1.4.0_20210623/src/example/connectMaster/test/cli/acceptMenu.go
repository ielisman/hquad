...
func showAcceptFilter() error {
	filter, err := connectMasterSvc.GetAcceptFilter(gatewayID)
...
func showPendingList() error {
	devList, err := connectMasterSvc.GetPendingList(gatewayID)
...
func addDevicesToFilter() error {
	...
	err = connectMasterSvc.AddDeviceToAcceptFilter(gatewayID, devIDs)
...
func allowAllDevices() error {
	...
	err := connectMasterSvc.SetAcceptFilter(gatewayID, filter)
...
func deleteDevicesFromFilter() error {
	...
	err = connectMasterSvc.DeleteDeviceFromAcceptFilter(devIDs)
