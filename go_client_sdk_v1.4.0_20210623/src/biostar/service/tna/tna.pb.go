...
type TNALog struct {
	...
	TNAKey               Key      `protobuf:"varint,7,opt,name=TNAKey,proto3,enum=tna.Key" json:"TNAKey,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *TNALog) GetSubCode() uint32 {
	if m != nil {
		return m.SubCode
	}
	return 0
...
type JobCodeLog struct {
	...
	EventCode            uint32   `protobuf:"varint,5,opt,name=eventCode,proto3" json:"eventCode,omitempty"`
	SubCode              uint32   `protobuf:"varint,6,opt,name=subCode,proto3" json:"subCode,omitempty"`
	JobCode              uint32   `protobuf:"varint,7,opt,name=jobCode,proto3" json:"jobCode,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *JobCodeLog) GetSubCode() uint32 {
	if m != nil {
		return m.SubCode
	}
	return 0
...
var fileDescriptor_86edf1ecf0cc73a5 = []byte{
	...
	,
}
